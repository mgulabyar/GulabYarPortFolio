    ...
    >
      ...
      >
        <div className="lg:col-span-7 flex flex-col gap-5">
          ...
          >
            <div className="pt-4 transition-[transform,color] duration-300 ease-out flex items-center gap-3 group cursor-pointer hover:translate-x-1">
              <Code2 className="h-5 w-5 text-brand-orange group-hover:scale-110 transition-transform duration-300 shrink-0" />
              <span className="text-xs font-bold uppercase tracking-wider text-white transition-colors duration-300 group-hover:text-brand-orange">
                Full Stack Web Dev
              </span>
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-6 w-full mt-4">
          <motion.div
            ...
            className="p-6 rounded-xl bg-slate-900/40 border border-white/5 hover:border-brand-orange/30 hover:shadow-glow-soft transition-[border-color,box-shadow,background-color] duration-500 ease-out flex flex-col items-start text-left group cursor-pointer"
          >
            <img
              src={excelIcon}
              alt="Excel Add-in Development"
              className="h-12 w-12 object-contain mb-4 filter brightness-[0.95] group-hover:scale-105 transition-transform duration-300"
              onError={(e) => {
                e.currentTarget.src =
            ...
            <span className="text-xs font-semibold text-brand-orange/90 group-hover:text-brand-orange mt-auto transition-colors duration-300 flex items-center gap-1">
      ...
      >
        ...
        <div className="lg:col-span-7 flex flex-col gap-5 lg:order-2">
          ...
          <motion.div variants={slideInRight} className="mt-2">
            <Link
              to="/contact"
              className="relative overflow-hidden px-5 py-2.5 rounded-lg border border-brand-orange text-white font-bold text-sm tracking-wide transition-[border-color,box-shadow] duration-500 flex items-center gap-2 group cursor-pointer max-w-max hover:shadow-[0_0_20px_rgba(255,85,0,0.25)]"
            >
