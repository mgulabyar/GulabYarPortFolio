    ...
    >
      ...
      >
        <NavLink
          to="/contact"
          className={({ isActive }) =>
            `relative overflow-hidden px-4 py-2 rounded-full border border-brand-orange font-bold text-xs tracking-wider uppercase transition-all duration-300 flex items-center justify-center group cursor-pointer hover:shadow-glow-orange ${
              isActive ? "bg-brand-orange/20" : ""
            }`
          }
        >
